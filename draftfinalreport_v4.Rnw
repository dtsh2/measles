...
break_even_vacc_cost50 <- format(35.70, big.mark=",") # vaccine costs such that benefits == cost (from .xlsx)
@
...
costtable_50pc<-read.csv("tables/cost_benefit_50pc.csv",header=T)
