...
@
\caption{Proportion of the currently na\"{\i}ve New Zealand population that would be immunised if all na\"{\i}ve people in each age range were immunised. The estimated additional proportion of the population requiring immunisation is 54\%}
\label{table:coh_vac}
\end{table}
