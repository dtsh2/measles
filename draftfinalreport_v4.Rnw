...
\item The benefit--cost (B/C) ratio analyses suggest additional vaccination is beneficial financially (B/C $>$1), with vaccination-related costs required to exceed approximately \$\Sexpr{break_even_vacc_cost} per person currently na\"{\i}ve immunized through vaccination before the costs exceed the benefits for all DHBs together.
