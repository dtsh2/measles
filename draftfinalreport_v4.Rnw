...
break_even_vacc_cost <- format(903, big.mark=",") # vaccine costs such that benefits == cost (from .xlsx)
@
...
%%%%%%%%% TODO %%%%%%%%%%%%%%%%%%% ABOVE TABLE %%%%%%%%%%%%%%%%%%%%%%
%%%% find out why 'Cases' col name appears as 'Cases 1' %%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% check if \tiny means the page # is outside the table %%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%% TODO %%%%%%%%%%%%%%%%%%% ABOVE TABLE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% double check what the intercept is (age0-2:euro:nzdep1-3?) w JM %%%%%%%%%%%%%
%%%%%%%%%%%%%% add to the caption text %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%% TODO %%%%%%%%%%%%%%%%%%% ABOVE TEXT %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%% NIGEL DISLIKES ALL THE HYPERLINKS - CHANGE TO 'Figures 26--37' ? %%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%% TODO %%%%%%%%%%%%%%%%%%% BELOW 'RISK' TABLES and FIGURES %%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% CHECK UNITS FOR RISK ARE 'CASES PER MILLION TRAVELLERS PER YEAR' %%%%%%%%
%%% was annual incidence per million * # travellers per year %%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%% TODO %%%%%%%%%%%%%%%%%%% BELOW 'RISK' TABLES and FIGURES %%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% ADD UNITS FOR RISK TO CAPTIONS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
@
\caption{Indicator of risk of measles importation to New Zealand due to New Zealander travel in 2013, estimated by all traveller numbers multiplied by measles incidence in the source or destination location, see also \autoref{table:imrisk12} and \autoref{table:risk12}.}
...
@
\caption{Indicator of risk of measles importation to New Zealand due to non-New Zealander 0--19 year old travel and immigration in 2013, estimated by traveller numbers multiplied by measles incidence in the source or destination location, see also \autoref{table:nzrisk12} and \autoref{table:risk12}.}
...
%%%%%%%%% TODO %%%%%%%%%%%%%%%%%%% ABOVE/BELOW RE REGRESSION %%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% NF COMMENT - WHAT'S THE AIM OF THE REGRESSION - PARSIMONIOUS MODEL? %%%%%
%%%%%%%%%%%%%%% good point! NOT SURE TC DID AND I LEFT IN %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%% but %%%%%%%%%%%%% MAYBE IGNORE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%% TODO %%%%%%%%%%%%%%%%%%% ABOVE RE REGRESSION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% NF COMMENT - COSTS CALCULATED FROM DATA, SO NOT INDEPENDENT %%%%%%%%%%%%%%
%%%%%%%%%%%%%%% good point! NOT SURE TC DID AND I LEFT IN %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%% but %%%%%%%%%%%%% MAYBE IGNORE AGAIN %%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{sidewaystable}\small
<<results=tex,echo=FALSE>>=
colnames(costtable20)<-c("DHB", "Vacc", "Vacc costs", "Wages saved", "Manage saved", "Hosp saved", "Contacts","Costs saved", "Outbreak", "OB costs", "B/C","NPV","NPV")
...
\begin{sidewaystable}\small
<<results=tex,echo=FALSE>>=
colnames(costtable74)<-c("DHB", "Vacc", "Vacc costs", "Wages saved", "Manage saved", "Hosp saved", "Contacts","Costs saved", "Outbreak", "OB costs", "B/C","NPV","NPV")
...
\begin{sidewaystable}\small
<<results=tex,echo=FALSE>>=
colnames(costtable20_no)<-c("DHB", "Vacc", "Vacc costs", "Wages saved", "Manage saved", "Hosp saved", "Contacts","Costs saved", "Outbreak", "OB costs", "B/C","NPV","NPV")
