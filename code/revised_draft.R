...
par(cex.axis=1)
hist(time$AgeInYears,col="grey",xlab="Age in years",main="",breaks=90,include.lowest=TRUE,
     right=F,ylab="Number of cases",cex.lab=1)
...
par(mar=c(5,6,4,2)+0.1)
par(cex.axis=1)
barplot(t(AgeVac),xlab="Age",col=c("darkgrey","red","orange"),main="",ylab="Number of cases",cex.lab=1)
...
par(mar=c(5,6,4,2)+0.1)
par(cex.axis=1)
hist(vac$Dose1Mths,breaks=100,col=rgb(0,0,1,1/4),xlab="Age in months",
...
hist(vac$Dose1Mths,breaks=100,col=rgb(0,0,1,1/4),xlab="Age in months",
     main="",cex.lab=1,ylab="Number of cases",xlim=c(0,100))
abline(v=15,col="blue")
hist(vac$Dose2Mths,breaks=50,add=T,col=rgb(1,0,0,1/4),xlim=c(0,100))
abline(v=48,col="red")
legend("topright",c("Dose 1","Dose 2"),col=c(rgb(0,0,1,1/4),rgb(1,0,0,1/4)),pch=15,bty="n",cex=1)
legend("right",c("15 months","48 months"),col=c("blue","red"),lty=1,bty="n",cex=1)
dev.off()
...
par(mar=c(5,6,4,2)+0.1)
par(cex.axis=1)
barplot(t(DOBVac),xlab="Age",col=c("darkgrey","red","orange"),main="",
        ylab="Number of cases",cex.lab=1)
...
par(cex.axis=1)
par(mfrow=c(2,1))
barplot(DOBVac[,2],col=rgb(0,0,1,1/4),xlab="Year of birth",main="",
        cex.lab=1,ylab="Number of cases")
legend("topleft",c("Dose 1"),col=rgb(0,0,1,1/4),pch=15,bty="n",cex=1)
par(mar=c(5,6,4,2)+0.1)
par(cex.axis=1)
barplot(DOBVac[,3],col=rgb(1,0,0,1/4),xlab="Year of birth",main="",
        cex.lab=1,ylab="Number of cases")
...
par(cex.axis=1)
par(mfrow=c(1,1))
barplot(DOBVac[,1],col="grey",xlab="Year of Birth",main="",
        cex.lab=1,ylab="Number of cases")
